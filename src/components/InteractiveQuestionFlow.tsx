                ...
                return (
                  ...
                  >
                    <Button
                      ...
                      className={cn(
                        "w-full justify-start text-left h-auto py-3 px-4 text-sm font-normal transition-all overflow-hidden",
                        isSelected
                    ...
                    >
                      <span className="flex flex-col sm:flex-row sm:items-center sm:justify-between w-full gap-1.5 sm:gap-2 min-w-0">
                        <span className="flex-1 min-w-0 break-words whitespace-normal">{option}</span>
