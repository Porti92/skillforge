  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[variant=inset]:border md:peer-data-[variant=inset]:border-solid md:peer-data-[variant=inset]:border-border md:peer-data-[variant=inset]:overflow-hidden",
        className
      )}
      {...props}
    />
